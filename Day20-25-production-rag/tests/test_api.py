...
class TestSearchEndpoint:
    ...
    def test_search_valid_query(self, client, populated_db_cursor, mock_openai_client):
        ...
        populated_db_cursor.fetchall.return_value = [
            ("081110 145404 34 INFO dfs.DataNode$PacketResponder: PacketResponder 0", 0.1),
        ...
        mock_retrieval.hybrid_search = lambda query, top_k: {
            "retrieved_logs": [
                {"text": "081110 145404 34 INFO dfs.DataNode$PacketResponder: PacketResponder 0", "hybrid_score": 0.9, "distance": 0.1},
                {"text": "081110 145404 35 ERROR dfs.DataNode$PacketResponder: Exception", "hybrid_score": 0.8, "distance": 0.2},
            ]
        }
...
class TestProgressEndpoint:
    ...
    def test_progress_idle(self, client):
        ...
        upload.upload_progress = {"total": 0, "processed": 0, "status": "idle", "start_time": None}
